...
export default function IntegrationToggle({
  ...
  return (
    <div className="flex items-center gap-2 p-1 bg-white/2 border border-white/10 rounded-xl">
      <button
        onClick={() => onModeChange("widget")}
        className={`px-4 py-2 rounded-lg font-medium text-sm transition-all ${
          mode === "widget"
            ? "bg-linear-to-r from-purple-primary to-blue-primary text-white shadow-lg"
